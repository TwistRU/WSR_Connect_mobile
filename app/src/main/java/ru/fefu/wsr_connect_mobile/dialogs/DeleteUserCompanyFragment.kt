...
import ru.fefu.wsr_connect_mobile.dialogs.view_models.DeleteUserCompanyViewModel


class DeleteUserCompanyFragment : DialogFragment(R.layout.fragment_delete_alert) {

    private val viewModel by lazy {
        ViewModelProvider(this)[DeleteUserCompanyViewModel::class.java]
    }
