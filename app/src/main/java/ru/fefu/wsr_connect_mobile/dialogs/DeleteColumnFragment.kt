...
import ru.fefu.wsr_connect_mobile.dialogs.view_models.DeleteColumnViewModel


class DeleteColumnFragment : DialogFragment(R.layout.fragment_delete_alert) {

    private val viewModel by lazy {
        ViewModelProvider(this)[DeleteColumnViewModel::class.java]
    }
