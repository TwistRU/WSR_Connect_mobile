...
class EditChatViewModel : ViewModel() {
    ...
    fun editGroupChat(image: Bitmap?, chatId: Int, chatName: String, deleteImg: Boolean?) {
        ...
        viewModelScope.launch {
            ...
            apiService.editGroupChat(body, chatId, chatName, deleteImg)
