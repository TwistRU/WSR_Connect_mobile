...
import ru.fefu.wsr_connect_mobile.dialogs.view_models.DeleteCardViewModel


class DeleteCardFragment : DialogFragment(R.layout.fragment_delete_alert) {

    private val viewModel by lazy {
        ViewModelProvider(this)[DeleteCardViewModel::class.java]
    }
