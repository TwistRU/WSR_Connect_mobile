...
import ru.fefu.wsr_connect_mobile.dialogs.view_models.DeleteUserBoardViewModel
import ru.fefu.wsr_connect_mobile.extensions.launchWhenStarted


class DeleteUserBoardFragment : DialogFragment(R.layout.fragment_delete_alert) {

    private val viewModel by lazy {
        ViewModelProvider(this)[DeleteUserBoardViewModel::class.java]
    }
