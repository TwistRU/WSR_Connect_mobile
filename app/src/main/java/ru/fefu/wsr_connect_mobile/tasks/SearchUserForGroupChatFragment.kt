...
import ru.fefu.wsr_connect_mobile.tasks.view_models.SearchUserForGroupChatViewModel

class SearchUserForGroupChatFragment :
    ...
    private val viewModel by lazy {
        ViewModelProvider(this)[SearchUserForGroupChatViewModel::class.java]
    }
        ...
        binding.apply {
            ...
            searchUserView.setOnQueryTextListener(object : SearchView.OnQueryTextListener,
                ...
                override fun onQueryTextChange(newText: String): Boolean {
                    ...
                    else viewModel.searchUserCompany(newText)
                    return false
                }
            })

            multipleAddContainer.setOnClickListener {
                viewModel.addUsersToGroupChat(adapter.users, chatId)
            }
        }
